...
public class WeixinTemplateMessageVO {
    ...
    private String touser = "oAg287YzcsPYNz7fjJoDrn56j9Cs";/*接收者openid*/
    private String template_id = "SL1O2kzTH9g8fEMucrOgg4Ds8zUBYLtxzzq9z_IwYZg";
    private String url = "https://gaga.plus";
